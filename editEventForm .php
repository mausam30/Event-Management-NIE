...
$gateway = new EevntTableGateway($connection);
        ...
        <div class="content">
            <div class="container">
                ...
                <form action="editLocation.php" method="POST" class="form-horizontal">
                    <input type="hidden" name="id" value="<?php echo $row['EventID']; ?>" /><!--location id. auto incremented in database. cannot be updated from website-->
                    <div class="form-group">
                        <label for="Name" class="col-md-2 control-label">Name</label><!--label-->
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Name" name="Name" value="<?php echo $row['Title']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="Address" name="Address" value="<?php echo $row['Description']; ?>" /><!--input with current data from database-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        <label for="ManagerFName" class="col-md-2 control-label">Link</label><!--label-->
                        <div class="col-md-5">
