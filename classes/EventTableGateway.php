...
class EventTableGateway {
    ...
    public function getEvents() {
        ...
        $sqlQuery = "SELECT e.*, l.name " .
                    "FROM events e " .
                    "LEFT JOIN locations l ON e.locationID = l.locationID order by e.StartDate" ;
    ...
    public function insert($p) {
        $sql = "INSERT INTO events(Title, Description, StartDate, EndDate,StartTime,EndTime,Link,  LocationID) " .
                "VALUES (:Title, :Description, :StartDate, :EndDate,:StartTime,:EndTime,:Link, :LocationID)";
