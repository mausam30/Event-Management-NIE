    ...
    <body>
        ...
        <div class = "content">
            <div class = "container">
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            . '</td>';
                            echo '<td>'
                            . '<a href="viewEvent2.php?id='.$row['EventID'].'">View</a> '
                ...
                ?>
                <a class="btn btn-default" href="viewLocations2.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
            </div>
        </div>
