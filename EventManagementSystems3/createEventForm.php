            ...
            <div class = "container">
                ...
                <form action="createEvent.php" method="POST" class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="StartTime" name="StartTime" value="<?php echoValue($formdata, "StartTime")?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-5">
                            <input type="text" class="form-control" id="EndTime" name="EndTime" value="<?php echoValue($formdata, "EndTime")?>" /><!--input-->
                        </div>
                        <div class="col-md-4">
