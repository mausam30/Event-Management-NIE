    ...
    <nav class="navbar">
        <div class="container">
            <div class="navbar-header"><!--website name/title-->
                ...
                echo '<a href = "index2.php" class = "navbar-brand">
            ...
            <ul class="nav navbar-nav navbar-right"><!--navigation-->
                ...
                if(is_logged_in()){
                    ...
                    echo '<li><a href = "viewEvents3.php">Events</a></li>';
                    echo '<li><a href = "viewLocations2.php">Locations</a></li>';
                    echo '<li><a href = "contact2.php">Contact Us</a></li>';
    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>ALL OF NIE MYSORE EVENTS</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
