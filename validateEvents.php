...
function validateEvents($input_method, &$formdata, &$errors) {
    ...
    $formdata['StartTime'] = filter_input($input_method, "StartTime", FILTER_SANITIZE_STRING);
    $formdata['EndTime'] = filter_input($input_method, "EndTime", FILTER_SANITIZE_STRING);
    $formdata['Link'] = filter_input($input_method, "Link", FILTER_SANITIZE_STRING);
