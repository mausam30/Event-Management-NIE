...
$gateway = new LinkTableGateway($connection);
$eventGateway = new EventTableGateway($connection);

$statement = $gateway->getLinksById($id);
    ...
    <body>
        ...
        <div class = "content">
            <div class = "container">
                ...
                <table class = "table table-hover">
                    <thead>
                        ...
                        <tr>
                            ...
                            <th>Location Name</th>
                            <th>Address</th>
                            <th>Hall head First Name</th>
                            <th>Hall head Last Name</th>
                            <th>Hall head Email</th>
                            <th>Hall head Contact Number</th>
                            <th>Max Capacity</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                ...
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        while ($row) {
                            ...
                            // echo '<td>' . $row['Cost'] . '</td>';
                            echo '<td>'
                            . '<a href="viewLink.php?id='.$row['EventID'].'">'.$row['name'].'</a> '
                            . '</td>';
                            echo '<td>'
                ...
                ?>
                <a class="btn btn-default" href="viewLinks.php"><span class="glyphicon glyphicon-circle-arrow-left"></span> Back</a>
            </div>
        </div>
